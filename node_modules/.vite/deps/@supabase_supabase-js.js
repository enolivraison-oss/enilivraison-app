  ...
  constructor(endPoint, options) {
    ...
    this._resolveFetch = (customFetch) => {
      ...
      if (customFetch) {
        ...
        _fetch = (...args) => import("./browser-7ILX4ERV.js").then(({ default: fetch2 }) => fetch2(...args)).catch((error) => {
...
var DEFAULT_HEADERS2 = { "X-Client-Info": `supabase-js/${version3}` };
...
function isInStackGuard(name) {
  ...
  const stack = (_b = (_a2 = error.stack) === null || _a2 === void 0 ? void 0 : _a2.split("\n")) !== null && _b !== void 0 ? _b : [];
